export const List = [
    {
        ...
        productDescription:"Samsung NVMe SSD 980 to pierwszy tak dostępny dla konsumentów dysk firmy Samsung bez pamięci DRAM."+ 
                            ...
                            "przez dyski SSD SATA.",
        productSpecs: {
            a:"Format: 3.5\"",
            b:"Pojemność:3 TB",
            c:"Prędkość: 7000 obr./min."
        }
    },
    {
        id:2,
        ...
        productDescription:"Karta graficzna ASRock Radeon RX 6600 Challenger D 8GB z przełomową architekturą AMD RDNA 2. "+
                            ...
                            "w rozdzielczości 1080p i która napędza nową generację gier dzięki żywym efektom wizualnym i wyjątkowym "+
                            "doznaniom.",
        productSpecs: {
            a:"Długość: 282 mm",
            b:"Pamięć ram: 12 GB",
            c:"Taktowanie rdzenia: 1837 MHz"
        }
    },
    {
        id:3,
        ...
        productSpecs: {
            a:"Liczba rdzeni: 6",
            b:"Typ gniazda: Socket AM4",
            c:"Częstotliwość taktowania procesora: 3.7 GHz"
        }
    },
    {
        id:4,
        ...
        polecamy:true,
        productSpecs: {
            a:"Procesor: Intel Core i5",
            b:"Pamięć ram: 16 GB",
            c:"Przekątna ekranu: 15\""
        }
    },
    {
        id:5,
        ...
        productDescription:"Nowy Notebook Samsung serii 9 to niewiarygodne połączenie lekkości, perfekcyjnego wykonania i niebywałych "+ 
                            ...
                            "działanie nawet najbardziej wymagających aplikacji.",
        productSpecs: {
            a:"Procesor: Intel Core i4",
            b:"Pamięć ram: 10 GB",
            c:"Przekątna ekranu: 20\""
        }
    },
    {
        id:6,
        ...
        productSpecs: {
            a:"Procesor: Intel Core i6",
            b:"Pamięć ram: 24 GB",
            c:"Przekątna Ekranu: 18\""
        }
    },
    {
        id:7,
    ...
    },
    {
        ...
        productDescription:"Zobacz, jak piękny i elegancki jest Samsung Galaxy S22. Smartfon cechuje odporność na wodę "+
                             ...
                             "godzin na rozrywce na własnych zasadach.",
        productSpecs: {
            a:"Pamięć: 256 GB",
            b:"Aparat: 100 MPix",
            c:"Przekątna Ekranu: 7\""
        }
    },
    {
        id:9,
    ...
    },
    {
        ...
        productDescription:"Nowy Galaxy Watch5 Pro to połączenie kultowego i klasycznego designu smartwatchy Galaxy oraz dopasowania "+ 
                            ...
                            "spośród dziesiątek eleganckich tarcz.",
        polecamy:true,
        productSpecs: {
            a:"GPS: tak",
            b:"NFC: nie",
            c:"Wodoodporność: IP68"
        }
    },
    {
        id:11,
        ...
        productDescription:"Xiaomi Mi Watch niebieski wyposażono w wodoszczelność na poziomie 5 ATM, dzięki temu niekorzystne warunki "+
                           "pogodowe nie są mu straszne. Włóż smartwatch na rękę, a zobaczysz, że jego wygląd nie raz sprawi, "+ 
                            "że zawiesisz na nim dłuższe spojrzenie.",
        productSpecs: {
            a:"GPS: nie",
            b:"NFC: tak",
            c:"Wodoodporność: 50 ATM"
        }
    },
    {
        id:12,
        ...
        productDescription:"Sport to zdrowie, a Ty chcesz mieć je pod kontrolą? Wybierz Garmin Venu 2S szary, "+ 
                            ...
                            "Ćwicz i nie myśl, że Twój zegarek zaraz się rozładuje. Venu 2S to pewność pracy nawet do 10 dni.",
        productSpecs: {
            a:"GPS: tak",
            b:"NFC: tak",
            c:"Wodoodporność: IP67"
        }
    }
]